...
\begin{document}
	...
	\begin{itemize}
		...
		\item[5.]	Aktuelle Posenwineklschätzung durch IMU-Sensorik aus dem \textit{ROS}-Netzwerk abonieren
		\item[6.]	Posenwinkelschätzung des verwendeten SLAM-Algorithmus aus dem \textit{ROS}-Netzwerk abonieren
	...
	\begin{itemize}
		...
		\item[6.]	Vergleich mit Lageplan des D3-Gebäudes
   ...
   \newline
	...
	ANF\_12 & Autonomes Fahren durch enge Passagen & Zur Durchführung sind folgende Arbeitsschritte durchzuführen:
	\begin{itemize}
		\item[1.]	ALF einschalten (Rechner hochfahren und Wahlschlüsselschalter auf „Hand“-Modus stellen)
		\item[2.]	Launch-File starten (Lokalisierung)
